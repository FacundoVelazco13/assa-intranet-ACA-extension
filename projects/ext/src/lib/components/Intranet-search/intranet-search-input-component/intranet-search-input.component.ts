...
import { IntranetSearchByTermAction } from '../../../store/actions';

@Component({
  selector: 'aca-intranet-search-input',
  imports: [
    CommonModule,
    TranslatePipe,
    MatMenuModule,
  ...
  templateUrl: './intranet-search-input.component.html',
  styleUrl: './intranet-search-input.component.scss',
  encapsulation: ViewEncapsulation.None,
  host: { class: 'aca-search-input' }
})
export class IntranetSearchInputComponent implements OnInit, OnDestroy {
  ...
  searchByOption() {
    ...
    if (this.isLibrariesChecked()) {
      ...
      if (this.onLibrariesSearchResults && this.isSameSearchTerm()) {
        ...
        this.store.dispatch(new IntranetSearchByTermAction(this.searchedWord, this.searchOptions));
      }
    } else {
